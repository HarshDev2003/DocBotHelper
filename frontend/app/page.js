  ...
  return (
    <>
      ...
      <div className="from-indigo-400 bg-gradient-to-b rounded-lg shadow-lg h-[80vh] xl:h-screen">
        <div className="w-full sm:w-1/2 float-left mx-30rem">
          <div className="text-center h-screen flex flex-col space-y-5 justify-center items-center text-3xl font-bold">
        ...
        <div className="relative w-full sm:w-1/2 h-screen flex justify-center items-center float-right">
          <Image
            src="/right.png"
            alt="Hero"
            fill
